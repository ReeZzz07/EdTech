...
- [ ] **NFR из ТЗ** — lazy loading тяжёлых экранов (частично уже в `App.tsx`), WebP, retry безопасных GET в Axios (сделано), понятные ошибки; минимальный Service Worker / offline по силам.
